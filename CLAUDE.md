...
**Estado atual:** incremento 1 em andamento. A spec da unidade 001 ([specs/001-fundacao-da-api/](specs/001-fundacao-da-api/spec.md)) está aprovada, com plano, contrato e `tasks.md`, e as tarefas já são issues no milestone "Incremento 1 — Fundação". **Ainda não existe código de aplicação.** O próximo passo é a Fase B, na branch `feature/001-fundacao-da-api` ([docs/09-roadmap.md](docs/09-roadmap.md)).
